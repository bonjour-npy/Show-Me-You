...
public class FindMineDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(view);
        com.example.photoshare.model.caogao.RecordsBean recordsBean = new com.example.photoshare.model.caogao.RecordsBean();
        ...
        recordsBean = (com.example.photoshare.model.caogao.RecordsBean) intent.getSerializableExtra("photolist");
